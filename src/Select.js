...
const Select = React.createClass({
  ...
  propTypes: {
    ...
    controlClassName: React.PropTypes.string,   // optional style to apply to the control container
    constantOpen: React.PropTypes.bool,         // should the outer-menu be always open for debugging
    ...
    freeWheelMutex: React.PropTypes.func,       // onMouseLeave handler in select-outer-menu component.
    ...
    outerClassName: React.PropTypes.string,     // optional style to apply to the outer-menu container
    ...
    seizeWheelMutex: React.PropTypes.func,      // onMouseEnter handler in select-outer-menu component.
  ...
  handleMouseDown (event) {
    ...
    if (!this.props.searchable) {
      ...
      let selectedOption = this.getValueArray(this.props.value)[0]
