...
var Value = _react2['default'].createClass({
	...
	propTypes: {
		...
		onMouseDown: _react2['default'].PropTypes.func, // method to handle mousedown on value label
	...
	renderLabel: function renderLabel() {
		...
		return this.props.onClick || this.props.value.href ? _react2['default'].createElement(
			...
			'span',
			{ className: className, role: 'option', 'aria-selected': 'true', id: this.props.id, onMouseDown: this.props.onMouseDown },
			this.props.children
		);
	},
...
var Select = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    controlClassName: _react2['default'].PropTypes.string, // optional style to apply to the control container
    constantOpen: _react2['default'].PropTypes.bool, // should the outer-menu be always open for debugging
    delimiter: _react2['default'].PropTypes.string, // delimiter to use to join multiple values for the hidden field value
    disabled: _react2['default'].PropTypes.bool, // whether the Select is disabled or not
    escapeClearsValue: _react2['default'].PropTypes.bool, // whether escape clears the value when the menu is closed
    filterOption: _react2['default'].PropTypes.func, // method to filter a single option (option, filterString)
    filterOptions: _react2['default'].PropTypes.any, // boolean to enable default filtering or function to filter the options array ([options], filterString, [values])
    freeWheelMutex: _react2['default'].PropTypes.func, // onMouseLeave handler in select-outer-menu component.
    ...
    outerClassName: _react2['default'].PropTypes.string, // optional style to apply to the outer-menu container
    ...
    seizeWheelMutex: _react2['default'].PropTypes.func, // onMouseEnter handler in select-outer-menu component.
  ...
  getDefaultProps: function getDefaultProps() {
    return {
      ...
      filterOptions: true,
      freeWheelMutex: function freeWheelMutex() {},
      ignoreAccents: true,
      ignoreCase: true,
      inputClassName: '',
      inputProps: {},
      ...
      searchable: false,
      seizeWheelMutex: function seizeWheelMutex() {},
      showArrow: false,
      simpleValue: false,
  ...
  handleMouseDown: function handleMouseDown(event) {
    ...
    if (!this.props.searchable) {
      ...
      // Every time the menu opens, focused entry is initialized to this.props.value.
      var selectedOption = this.getValueArray(this.props.value)[0];
      return this.setState({
  ...
  getFocusableOptionIndex: function getFocusableOptionIndex(selectedOption) {
    ...
    // Latest focused option is always initialized to this.props.value, each time menu opens.
  ...
  render: function render() {
    ...
    var isOpen = this.state.isOpen;
    var constantOpen = this.props.constantOpen;
